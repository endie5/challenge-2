...
#from qualifier.utils.fileio import get_headers
...
def save_qualifying_loans(qualifying_loans):
    ...
    # YOUR CODE HERE!
    save_option = questionary.confirm("Would you like to save your qualifying loans to a CSV file? ").ask() 
    if (save_option):
        csv_path = questionary.text(r"Enter a file path to save the rate-sheet (ex. C:\Users\User1\Desktop):").ask()
        csv_path = Path(csv_path)
        save_csv(qualifying_loans, str(csv_path), ["Lender","Max Loan Amount", "Max LTV","Max DTI","Min,Credit Score","Interest Rate"])
